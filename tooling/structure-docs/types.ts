...
/** A `cva` variant axis, e.g. `size` with its `small`/`normal`/`large` options. */
...
export type ThemePart = {
	...
	used: boolean;
	/** The part's `cva` base classes (always applied), when resolvable. */
	base?: string;
	/** The part's `cva` variant axes, absent when the part has none. */
	variants?: ThemeVariant[];
	/** The `cva` `defaultVariants` map (variant name -> selected value). */
