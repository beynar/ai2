	...
	>
		<div class="grid justify-items-center gap-3">
			<AIModelSelector
				...
				bind:query
			/>
			<div class="text-foreground/60 text-center text-xs">
		...
		>
			{#if exampleControls.value.example === 'conversation'}
				<div class="grid justify-items-center gap-3">
					...
					<div class="text-foreground/60 text-xs">Conversation value: {conversationValue}</div>
				</div>
			...
			{:else if exampleControls.value.example === 'explicit-empty'}
				<div class="grid justify-items-center gap-3">
					...
					<div class="text-foreground/60 text-xs">Inherited model · Direct empty</div>
				</div>
			{:else}
