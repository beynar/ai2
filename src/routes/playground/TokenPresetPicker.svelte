	...
	<div class="grid grid-cols-2 gap-2">
		{#each runtimeThemePresetNames as presetName (presetName)}
			...
			<button
				...
				class="state-layer border-neutral-muted grid min-w-0 gap-0.5 rounded-lg border p-3 text-left transition-colors data-[pressed=true]:border-primary data-[pressed=true]:text-primary"
			...
			>
				...
				<span class="mt-1 flex items-center gap-1.5 text-xs">
					<span
